"use client";
import { Moeda, Produto } from "@/app/core";
import Image from "next/image";
import Link from "next/link";
import { IconShoppingCartPlus } from "@tabler/icons-react"; // Adjust the import path as necessary
...
export default function ProdutoItem(props: ProdutoItemProps) {
  ...
  return (
    <Link
      ...
      className="flex flex-col bg-violet-dark border border-white/10 relative max-w-[350px] rounded-xl overflow-hidden"
    >
      ...
      <div className="flex-1 flex flex-col gap-3 p-5 border-t border-white/10">
        ...
        bg-violet-700 hover: border-2 border-emerald-500 rounded-xl
        "
          onClick={(e) => {
            e.preventDefault();
        ...
        >
          <IconShoppingCartPlus size={20}></IconShoppingCartPlus>
